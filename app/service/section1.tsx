        ...
        <div className="flex flex-wrap flex-row justify-center">
          {card.map((card, index) => (
            <a
              key={index}
              href={card.link}
              className="flex flex-col bg-white hover:bg-blue-200 border-1 border-blue-200 shadow-lg shadow-blue-300 rounded-lg m-7 p-20 w-75 justify-center text-center items-center text-black transition-all duration-700 ease-in-out"
            >
              {card.svg}
