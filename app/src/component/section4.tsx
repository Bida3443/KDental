  ...
  const svig = [
    {
      svg: (
        <svg
          ...
          viewBox="0 0 512 512"
          className="w-20 fill-black stroke-white flex flex-col"
        >
    ...
    },
    {
       ...
       <svg xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 512 512"
        className="w-20 fill-black stroke-white">
    ...
    <div className="flex flex-col items-center justify-center m-10 ">
      ...
      <div className="flex flex-row">
        {svig.map((svig, index) => (
          <div
            key={index}
            className="flex flex-col bg-white border-1 border-blue-200 shadow-lg shadow-blue-300 rounded-lg m-10 p-20 justify-center items-center text-black"
          >
            <a href={svig.link}></a>
            {svig.svg}
            {svig.text}
      ...
      <div className="flex bg-blue-500 rounded-md p-2 text-white">
        <a href="#" className="text-[20px] font-bold hover-blue-700">VIEW ALL SERVICES</a>
      </div>
    </div>
  );
}
